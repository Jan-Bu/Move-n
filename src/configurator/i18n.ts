...
const cs = {
  ...
  'address.elevatorType.label': 'Typ výtahu',
  'address.elevatorType.placeholder': 'Vyberte typ…',
  'address.elevatorType.elevator_1_3': 'Výtah pro 1–3 osoby',
  'address.elevatorType.elevator_4_6': 'Výtah pro 4–6 osob',
  'address.elevatorType.elevator_7_9': 'Výtah pro 7–9 osob',
  'address.elevatorType.elevator_10plus': 'Výtah pro 10+ osob',
  'address.elevatorType.info': 'Na štítku uvnitř výtahu je uvedeno, pro kolik osob je určen. Prosíme, ověřte tuto informaci.',
  ...
  'services.heavyItems': 'Váží některý nábytek více než 100 kg?',
  'services.heavyItemsCount': 'Počet těžkých předmětů (nad 100 kg)',
  ...
  'no': 'Ne',
  'floor': 'patro',
  'price.title': 'Orientační cena',
  'price.trips': 'Počet jízd',
  'price.loadTime': 'Čas nakládání',
  'price.unloadTime': 'Čas vykládání',
  'price.totalTime': 'Celkový čas',
  'price.labor': 'Práce',
  'price.transport': 'Doprava',
  'price.stairSurcharge': 'Příplatek za schody',
  'price.heavyItemSurcharge': 'Příplatek za těžké předměty',
  'price.total': 'Celková cena',
  'price.minutes': 'min',
  'price.hours': 'hod',
...
const en = {
  ...
  'address.elevatorType.label': 'Elevator type',
  'address.elevatorType.placeholder': 'Select type…',
  'address.elevatorType.elevator_1_3': 'Elevator for 1–3 people',
  'address.elevatorType.elevator_4_6': 'Elevator for 4–6 people',
  'address.elevatorType.elevator_7_9': 'Elevator for 7–9 people',
  'address.elevatorType.elevator_10plus': 'Elevator for 10+ people',
  'address.elevatorType.info': 'The label inside the elevator indicates the number of people it is designed for. Please verify this information.',
  ...
  'services.heavyItems': 'Do you have furniture weighing more than 100 kg?',
  'services.heavyItemsCount': 'Number of heavy items (over 100 kg)',
  ...
  'no': 'No',
  'floor': 'floor',
  'price.title': 'Estimated Price',
  'price.trips': 'Number of trips',
  'price.loadTime': 'Loading time',
  'price.unloadTime': 'Unloading time',
  'price.totalTime': 'Total time',
  'price.labor': 'Labor',
  'price.transport': 'Transport',
  'price.stairSurcharge': 'Stair surcharge',
  'price.heavyItemSurcharge': 'Heavy item surcharge',
