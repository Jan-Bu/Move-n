export interface City {
  name: string; // 1st case (nominative) - Praha, Brno
  nameLocative: string; // 6th case (locative) - Praze, Brně
  nameGenitive: string; // 2nd case (genitive) - Prahy, Brna
  slug: string;
  description: string;
...
export const cities: City[] = [
  ...
  },
  {
    ...
    nameGenitive: 'Brna',
    slug: 'brno',
    description: 'V Brně poskytujeme komplexní stěhovací služby pro domácnosti i firmy. Perfektně známe město a jeho specifika, což nám umožňuje plánovat optimální trasy a zajistit rychlé stěhování. S MOVI-N je vaše stěhování v Brně v bezpečných rukou.',
    ...
    metaTitle: 'Stěhování Brno | Rychlé a bezpečné stěhovací služby | MOVI-N',
    metaDescription: 'Profesionální stěhování v Brně. MOVI-N zajistí bezproblémové stěhování po celém městě i okolí. Zkušení stěhováci, moderní vybavení, konkurenceschopné ceny. ✓ Kontaktujte nás.',
    faq: [
      {
  ...
  {
    name: 'Ostrava',
    nameLocative: 'Ostravě',
    nameGenitive: 'Ostravy',
    slug: 'ostrava',
  ...
  {
    name: 'Havířov',
    nameLocative: 'Havířově',
    nameGenitive: 'Havířova',
    slug: 'havirov',
    description: 'V Havířově zajišťujeme profesionální stěhování bytů, domů i kanceláří. Naši stěhováci dokonale znají město a okolí, což zaručuje hladký průběh celého stěhování. MOVI-N je vaším spolehlivým partnerem pro stěhování v Havířově.',
    longDescription: 'Havířov, statutární město v Moravskoslezském kraji, je známé svou specifickou urbanistikou s rozsáhlými panelovými sídlišti. MOVI-N má bohaté zkušenosti se stěhováním v tomto městě a dokonale zná všechny městské obvody včetně Havířova-Města, Prostřední Suchá, Šumbark a Bludovice. Naše služby pokrývají stěhování v bytových domech různých typů, od starších paneláků až po modernizované byty. Znalost místních podmínek nám umožňuje efektivně plánovat stěhování s ohledem na dostupnost parkovacích míst a přístupové cesty. Havířov má dobré dopravní napojení, což využíváme pro rychlé a bezpečné přesuny. Nabízíme komplexní služby od balení věcí, přes demontáž a montáž nábytku až po závěrečný úklid. Díky blízkosti Ostravy a Frýdku-Místku jsme ideálním partnerem i pro meziměstské stěhování. Naši pracovníci jsou profesionálové s dlouholetou praxí, kteří dokážou efektivně zvládnout i náročná stěhování včetně přesunu klavírů, sejfů nebo jiných těžkých předmětů. Poskytujeme pojištění nákladu a garantujeme bezpečné zacházení s vašim majetkem.',
    metaTitle: 'Stěhování Havířov | Profesionální stěhovací služby | MOVI-N',
    metaDescription: 'Stěhování v Havířově s MOVI-N. Komplexní stěhovací služby, zkušený tým, pojištění nákladu a konkurenceschopné ceny. ✓ Nezávazná poptávka zdarma.',
    faq: [
      {
  ...
  {
    name: 'Liberec',
    nameLocative: 'Liberci',
    nameGenitive: 'Liberce',
    slug: 'liberec',
    description: 'Stěhování v Liberci a Libereckém kraji s plným servisem. Naše společnost má zkušenosti se stěhováním v horském terénu i městském prostředí. Zajistíme kompletní služby od balení po usazení nábytku v novém domově v Liberci.',
    longDescription: 'Liberec, krajské město na úpatí Jizerských hor, představuje pro stěhovací služby specifické výzvy díky svému kopcovitému terénu. MOVI-N má bohaté zkušenosti se stěhováním v této oblasti a dokonale zná všechny liberecké čtvrti od centra přes Rochlici až po Ruprechtice a Vratislavice. Naše služby jsou přizpůsobeny specifickým podmínkám horského města s jeho strmými ulicemi a rozmanitou zástavbou. Liberec kombinuje historickou architekturu s moderními rezidenčními projekty, což vyžaduje flexibilní přístup k jednotlivým zakázkám. Naši řidiči jsou zkušení s jízdou v zimních podmínkách a kopcovitém terénu. Zajišťujeme stěhování bytů, rodinných domů i chat v širším okolí včetně horských oblastí. Díky znalosti místních podmínek dokážeme efektivně plánovat trasy a časování stěhování. Nabízíme také služby pro studenty Technické univerzity a vysokých škol v Liberci. Naše vozidla různých velikostí umožňují přístup i do užších ulic starší zástavby. Poskytujeme komplexní balení s použitím kvalitních obalových materiálů a zajišťujeme pojištění přepravovaného nákladu.',
    metaTitle: 'Stěhování Liberec | Stěhovací služby v Liberci a okolí | MOVI-N',
    metaDescription: 'Hledáte stěhování v Liberci? MOVI-N poskytuje komplexní stěhovací služby v celém Libereckém kraji. Profesionální přístup, moderní technika. ✓ Poptejte si nabídku.',
    faq: [
      {
